...
class FinalBut extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FinalButState();
  }
}

class _FinalButState extends State {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("Final Büt Kaç Almalıyım"),
          centerTitle: true,
          leading: BackButton(
            onPressed: () => Navigator.pop(context),
          ),
        ),
        body: buildCalculatePage(
          vz,
          vzEtki,
          fnl,
          fnlEtki,
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(
              "images/fnl_but.png", // burdaki resim kartın üzerindekinin transı olacak.
            ),
            fit: BoxFit.contain,
          )),
                ...
                onPressed: () {
                  showDialog<String>(
                      ...
                      builder: (BuildContext context) => AlertDialog(
                            ...
                            content: Text(calculateAverage(vz, vzEtki, fnl, fnlEtki) + "!!!"),
                            actions: [
                              FlatButton(
                                child: Text("Geri"),
  ...
  String calculateAverage(int vz, int vzEtki, int fnl, int fnlEtki) {
    ...
    return "Tebrikler " + result.toString();
  }
}
